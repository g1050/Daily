...
#include "../QtCustomProgressbar/ringsprogressbar.h"
...
const QMetaObject RingsProgressbar::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RingsProgressbar.data,
      qt_meta_data_RingsProgressbar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *RingsProgressbar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_RingsProgressbar.stringdata0))
        return static_cast<void*>(const_cast< RingsProgressbar*>(this));
